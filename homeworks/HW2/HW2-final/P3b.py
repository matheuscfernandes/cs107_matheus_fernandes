...
print('Did not work because the identifier balance refers to a previously bound variable that was defined outside of this frame -- therefore you can read, but you cannot change the variable.')
