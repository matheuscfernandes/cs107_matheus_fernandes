...
# Initialize weights and biases with random generator
# w1 = np.random.uniform(0,1,shape1[0]*shape1[1]).reshape(shape1)
# w2 = np.random.uniform(0,1,shape2[0]*shape2[1]).reshape(shape2)
# b1 = np.random.uniform(0,1,shape1[1])
# b2 = np.random.uniform(0,1,shape2[1])
